...
export async function GET(request: Request) {
  ...
  try {
    await recoverOperatorNotification();
  } catch {
    // Operator push failures must never prevent customer search recovery.
    console.error("[operator-notifications:recovery-failed]");
  }
