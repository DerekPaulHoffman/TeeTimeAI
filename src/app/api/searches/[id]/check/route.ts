...
import { getTeeSearchForPoc, getTeeSearchForUser } from "@/lib/searches/service";
...
export async function POST(
  ...
  try {
    ...
    const search = hasClerkConfig() ? await getOwnedSearch(id) : await getTeeSearchForPoc(id);
    if (!search) {
