...
export const MIN_COURSE_SEARCH_RADIUS_MILES = COURSE_SEARCH_RADIUS_OPTIONS_MILES[0];
export const MAX_COURSE_SEARCH_RADIUS_MILES =
  COURSE_SEARCH_RADIUS_OPTIONS_MILES[COURSE_SEARCH_RADIUS_OPTIONS_MILES.length - 1];
