...
- **The course-support Codex responder owns provider coverage incidents.** It runs every 2 minutes and resolves them with reusable support or final evidence-backed dispositions. Up to five unrelated provider groups may remain owned concurrently so one five-course alert can meet its 30-minute endpoint deadline; provider-family and global request leases still serialize actual provider traffic.
